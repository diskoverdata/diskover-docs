...
Organizations often preserve their assets/intellectual properties within tape-based archives systems like the Atempo Miria platform. The Diskover Atempo Scanner is designed to index all the files within the Atempo Miria archive system and presents them as a volume within the Diskover user interface.
