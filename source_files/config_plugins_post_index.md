...
## Plugins Configuration | Post-Index
...
| EDITION |  PLUGIN |
| --- | --- |
| **Core Editions** | <ul><li>[AutoClean]()</li><li>[AutoTag]()</li><li>[Breadcrumb]()</li><li>[Checksums]()</li><li>[Checksums S3]()</li><li>[Costs]()</li><li>[Dupes Finder]()</li><li>[ES Field Copier]()</li><li>[ES Query Report]()</li><li>[Illegal Filename]()</li><li>[Index Diff]()</li><li>[Tag Copier]()</li><li>[Windows Attributes]()</li></ul> |
| **Media** | <ul><li>[Flow Production Tracking Index Plugin (formerly ShotGrid)](#plugin_shotgrid)</li><li>[Xytec Asset Creation Index Plugin](#plugin_xytech_asset_creation)</li><li>[Xytec Order Status Index Plugin](#plugin_xytech_order_status)</li></ul> |
| **Life Science** | <ul><li></li></ul> |
